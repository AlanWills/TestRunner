...
namespace TestRunner.UserControls
{
    ...
    public sealed partial class FilePicker : Page
    {
        ...
        {
            InitializeComponent();
            filePathProperty = DependencyProperty.Register("FilePath", typeof(string), typeof(FilePicker), new PropertyMetadata(""));
            fileExtensionProperty = DependencyProperty.Register("FileExtension", typeof(string), typeof(FilePicker), new PropertyMetadata(""));
        }
